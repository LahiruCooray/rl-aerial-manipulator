...
np.save("pid_actual_positions_episodes.npy", np.array(all_actual, dtype=object))
np.save("pid_desired_positions_episodes.npy", np.array(all_desired, dtype=object))
print("Saved PID data for all episodes.")