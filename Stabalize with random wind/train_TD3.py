...
from lib.customEnv import DroneEnvironment
...
# Create the replay buffer ( data_s
...
dataset = replay_buffer.as_dataset(num_parallel_calls=3, sample_batch_size=batch_size, num_steps=2).prefetch(3) # read batches of 512 elements, each with 2 timesteps
